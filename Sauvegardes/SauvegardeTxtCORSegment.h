...
/*
* Cette classe hérite de SauvegardeTxtCOR, elle correspond au maillon de la chaine de responsabilité pouvant lire un segment
*/
...
public:
	...
	*/
	...
	/*
	* @brief Cette méthode tente de lire un Segment dans la chaine de caractère
